...
from src.ui.login_logic import Logic
...
class Login():
    def __init__(self, root:tk.Tk, call_display):
        ...
        self.login_user.grid(row=1, column=0, pady=5, padx=10, ipady=5)
        self.login_pass.grid(row=2, column=0, pady=5, padx=10, ipady=5)
        ...
        self.new_user.grid(row=1, column=0, pady=5, padx=10, ipady=5)
        self.new_pass.grid(row=2, column=0, pady=5, padx=10, ipady=5)
