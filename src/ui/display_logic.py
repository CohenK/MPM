...
from src.utils.google_drive_util import GoogleDriveClient
import pyperclip
from src.classes import Profile
import os
from src.ui.custom_widget_classes import Popup, Error_Window, Confirmation_Window
...
class Logic:
    ...
    def add_record(self):
            ...
            if site == '' or user == '' or password == '':
                Error_Window("One or more fields is empty.")
                return 
            if self.profile.add_site(site, user, password):
                ...
                Error_Window("Record already exists.")
    ...
    def edit_account(self):
        if not self.prev:
            Error_Window("No record was selected.")
            return
        ...
        if len(site) == 0 or len(username) == 0 or len(password)==0:
            ...
            Error_Window("Some fields are missing.")
            return
        self.clear_current_selected()
    ...
    def delete_record(self):
        ...
        if dialog.result.get():
            if self.profile.delete_user(site, username):
                ...
                Error_Window("No such record exists.")
        ...
        def change_password_window():
            ...
            if dialog.result.get():
                ...
                if password != '(New Password)':
                    ...
                    Error_Window("Password cannot be empty.")
        ...
        def change_username_window():
            ...
            if dialog.result.get():
                ...
                if user != '(New Username)':
                    ...
                    Error_Window("Username cannot be empty.")
